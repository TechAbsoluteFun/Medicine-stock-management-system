...
$result = mysqli_query($mysqli, "SELECT * FROM stock_sales ORDER BY id DESC"); // using mysqli_query instead
?>
      ...
      <tr>
        ...
        //while($res = mysql_fetch_array($result)) { // mysql_fetch_array is deprecated, we need to use mysqli_fetch_array
          while($res = mysqli_fetch_array($result)) {         
            ...
            echo "<td> <a href=\"delete2.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";        
        }
        ?>
