...
<center>
<br><br><br>
<form name="myForm" method="post" action="update11_stock_details.php" onsubmit="return validateForm();">
...
<br><br>
	    ...
	    <tr>
		   ...
		   &nbsp; &nbsp; &nbsp &nbsp
			<input type="submit" class="button" style="width:70px;height:30px;" value="submit" name="submit"><BR><BR>
			<!--<a href="update21_stock_details.php" target="content"><center>PRINT INVOICE</a></center><BR><BR><BR>-->
			</td>
		</tr>
	</tbody></table>
